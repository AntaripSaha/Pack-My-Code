...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 30, 2023 at 06:58 AM
...
(3, 'admin', 'admin@gmail.com', 'admin@gmail.com', NULL, NULL, '$2y$10$MkNC/5mVJ4Fyts5pVKJ3j.J3u6bcbX9DmTjpBVR74yWcA9Rzl/6FW', NULL, NULL, NULL);
...
(1, 'admin@gmail.com', '477622', 1, '2023-05-30 10:13:31', NULL),
(2, 'antarip15@gmail.com', '907230', 1, '2023-05-30 10:14:02', NULL),
(3, 'antarip15@gmail.com', '234935', 1, '2023-05-30 10:15:25', NULL);
...
CREATE TABLE IF NOT EXISTS `carts` (
  ...
  `support_time` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `general_settings` (
  ...
  `api` tinyint UNSIGNED NOT NULL DEFAULT '1',
  ...
  `server_name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `screenshots` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `demo_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `update_reject` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
DROP TABLE IF EXISTS `reviewer_logins`;
CREATE TABLE IF NOT EXISTS `reviewer_logins` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `reviewer_id` int NOT NULL,
  `reviewer_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `reviewer_password_resets`;
...
CREATE TABLE IF NOT EXISTS `reviews` (
  ...
  `report_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `sells` (
  ...
  `reject_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `trx` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `temp_products` (
  ...
  `tag` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `message` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_details` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
